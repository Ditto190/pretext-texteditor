...
- In `white-space: pre-wrap`, a line holding only soft hyphens between two newlines now counts as a line, as browsers draw it, instead of disappearing. In Safari, so does a line holding only soft hyphens or spaces between two line or paragraph separators (U+2028, U+2029).
